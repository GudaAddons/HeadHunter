...
L.HELP_ARENA = "|cffffff00/hh arena|r: Are you in Gurubashi Arena? Shows your position"
L.ARENA_WHERE = "%s at %s: %s"
L.ARENA_IN_PIT = "|cff40ff40in the arena pit|r"
L.ARENA_IN_ARENA = "|cff40ff40in Gurubashi Arena|r (stands)"
L.ARENA_OUTSIDE = "|cffff8000not in Gurubashi Arena|r"
...
L.TOUR_REMIND_CHAT = "|cffffd100%s|r starts in %d min in Gurubashi Arena (Stranglethorn Vale). Be there for the check-in."
L.TOUR_REMIND_OPEN = "Gurubashi Tournament |cffffd100%s|r starts in %d min and you can still join: /hh tour."
L.TOUR_CHECKIN_CENTER = "|cffffd100%s|r: check-in! Click I'm here in Gurubashi Arena."
L.TOUR_CHECKIN_CHAT = "|cffffd100%s|r: check-in is open. Go to Gurubashi Arena and click I'm here (Tournaments tab or /hh tour here) within %d min."
L.TOUR_CHECKIN_POPUP = "Gurubashi Tournament\n\n|cffffd100%s|r: check-in is open.\nAre you in Gurubashi Arena?"
...
L.TOUR_ERR_NOT_IN_ARENA = "You must be in Gurubashi Arena (Stranglethorn Vale) to check in."
...
L.EMPTY_TOURS = "No tournaments yet. Click Create to host one in Gurubashi Arena."
...
L.TOUR_ERR_LEVEL = "Minimum level: 1 to 60."
...
L.EMPTY_DUELS = "No duelists yet. Duels seen by HeadHunters show up here after 5 duels."
