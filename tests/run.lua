...
local SUITES = {
    ...
    "test_protocol", "test_sync", "test_rules_engine", "test_wanted", "test_alerts", "test_activity", "test_posse", "test_layer", "test_pets", "test_hotspots", "test_map_markers", "test_justice", "test_catchup", "test_main_window", "test_tooltip_line", "test_poster",
}
