...
local SUITES = {
    ...
    "test_protocol", "test_sync", "test_rules_engine", "test_wanted", "test_alerts", "test_activity", "test_posse", "test_layer", "test_pets", "test_hotspots", "test_map_markers", "test_justice", "test_catchup", "test_main_window", "test_tooltip_line", "test_poster", "test_settings_panel", "test_marks", "test_level_window", "test_high_noon", "test_tournament", "test_zones", "test_demo", "test_site_data",
}
